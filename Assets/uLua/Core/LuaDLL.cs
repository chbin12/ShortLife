...
//        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)] 	// del by chenbin
//        public static extern void lua_pushinteger(IntPtr luaState, int number);	// del by chenbin

		public static void lua_pushinteger(IntPtr L, int n) {		// add by chenbin
			lua_pushnumber (L, n);		// add by chenbin
		}		// add by chenbin
