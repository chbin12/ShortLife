...
public class UITweenerWrap
{
	public static void Register(IntPtr L)
	{
		...
		{
			new LuaField("exeOrder", get_exeOrder, set_exeOrder),
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_exeOrder(IntPtr L)
	{
		...
		if (obj == null)
		{
			...
			{
				LuaDLL.luaL_error(L, "unknown member name exeOrder");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index exeOrder on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.exeOrder);
		return 1;
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_exeOrder(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UITweener obj = (UITweener)o;
		...
		obj.exeOrder = (int)LuaScriptMgr.GetNumber(L, 3);
		return 0;
	}
