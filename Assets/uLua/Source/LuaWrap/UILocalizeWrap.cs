...
public class UILocalizeWrap
{
	public static void Register(IntPtr L)
	{
		...
		{
			new LuaMethod("New", _CreateUILocalize),
		...
		LuaScriptMgr.RegisterLib(L, "UILocalize", typeof(UILocalize), regs, fields, typeof(MonoBehaviour));
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateUILocalize(IntPtr L)
	{
		LuaDLL.luaL_error(L, "UILocalize class does not have a constructor function");
		return 0;
	}

	static Type classType = typeof(UILocalize);
