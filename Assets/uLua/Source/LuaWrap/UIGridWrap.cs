...
public class UIGridWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("changeOldClip", changeOldClip),
		...
		LuaField[] fields = new LuaField[]
		{
			...
			new LuaField("sorted", get_sorted, set_sorted),
			new LuaField("oldParentPos", get_oldParentPos, set_oldParentPos),
			new LuaField("oldParentClipOffset", get_oldParentClipOffset, set_oldParentClipOffset),
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_sorted(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UIGrid obj = (UIGrid)o;
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name sorted");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index sorted on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.sorted);
		return 1;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_oldParentPos(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UIGrid obj = (UIGrid)o;
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name oldParentPos");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index oldParentPos on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.oldParentPos);
		return 1;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_oldParentClipOffset(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UIGrid obj = (UIGrid)o;
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name oldParentClipOffset");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index oldParentClipOffset on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.oldParentClipOffset);
		return 1;
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_sorted(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UIGrid obj = (UIGrid)o;
		...
		obj.sorted = LuaScriptMgr.GetBoolean(L, 3);
		return 0;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_oldParentPos(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UIGrid obj = (UIGrid)o;
		...
		obj.oldParentPos = LuaScriptMgr.GetVector3(L, 3);
		return 0;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_oldParentClipOffset(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UIGrid obj = (UIGrid)o;
		...
		obj.oldParentClipOffset = LuaScriptMgr.GetVector2(L, 3);
		return 0;
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int changeOldClip(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 3);
		UIGrid obj = (UIGrid)LuaScriptMgr.GetUnityObjectSelf(L, 1, "UIGrid");
		Vector3 arg0 = LuaScriptMgr.GetVector3(L, 2);
		Vector2 arg1 = LuaScriptMgr.GetVector2(L, 3);
		obj.changeOldClip(arg0,arg1);
		return 0;
	}
