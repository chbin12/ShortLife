...
public class CLModelMgrWrap
{
	public static void Register(IntPtr L)
	{
		...
		LuaField[] fields = new LuaField[]
		{
			...
			new LuaField("dataAvatar", get_dataAvatar, set_dataAvatar),
		};
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_dataAvatar(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		CLModelMgr obj = (CLModelMgr)o;
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name dataAvatar");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index dataAvatar on a nil value");
			}
		}

		LuaScriptMgr.PushObject(L, obj.dataAvatar);
		return 1;
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_dataAvatar(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		CLModelMgr obj = (CLModelMgr)o;
		...
		obj.dataAvatar = (List<CLAvatar>)LuaScriptMgr.GetNetObject(L, 3, typeof(List<CLAvatar>));
		return 0;
	}
