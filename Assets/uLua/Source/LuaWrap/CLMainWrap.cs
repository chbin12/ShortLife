...
public class CLMainWrap
{
	public static void Register(IntPtr L)
	{
		...
		LuaField[] fields = new LuaField[]
		{
			...
			new LuaField("currOrientation", get_currOrientation, set_currOrientation),
		};
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_currOrientation(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		CLMain obj = (CLMain)o;
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name currOrientation");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index currOrientation on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.currOrientation);
		return 1;
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_currOrientation(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		CLMain obj = (CLMain)o;
		...
		obj.currOrientation = (DeviceOrientation)LuaScriptMgr.GetNetObject(L, 3, typeof(DeviceOrientation));
		return 0;
	}
