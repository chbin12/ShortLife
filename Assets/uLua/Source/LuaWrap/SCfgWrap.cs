...
public class SCfgWrap
{
	...
	static int get_player(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, obj.player);
		return 1;
	}
	...
	static int set_scene(IntPtr L)
	{
		...
		obj.scene = (CLBaseLua)LuaScriptMgr.GetUnityObject(L, 3, typeof(CLBaseLua));
		return 0;
	}
	...
	static int set_player(IntPtr L)
	{
		...
		obj.player = (CLUnit4Lua)LuaScriptMgr.GetUnityObject(L, 3, typeof(CLUnit4Lua));
		return 0;
	}
