...
public static class LuaBinder
{
	...
	public static void Bind(IntPtr L, string type = null)
	{
		...
		switch (type) {
			case "AIPathWrap": AIPathWrap.Register(L); break;
			...
			case "AstarPathWrap": AstarPathWrap.Register(L); break;
			...
			case "CLAIPathWrap": CLAIPathWrap.Register(L); break;
			case "CLAssetTypeWrap": CLAssetTypeWrap.Register(L); break;
			case "CLBaseLuaWrap": CLBaseLuaWrap.Register(L); break;
			case "CLBattleToolkitWrap": CLBattleToolkitWrap.Register(L); break;
			case "CLBattleWrap": CLBattleWrap.Register(L); break;
			case "CLBehaviour4LuaWrap": CLBehaviour4LuaWrap.Register(L); break;
			case "CLBulletPoolWrap": CLBulletPoolWrap.Register(L); break;
			case "CLCellBaseWrap": CLCellBaseWrap.Register(L); break;
			case "CLCellLuaWrap": CLCellLuaWrap.Register(L); break;
			case "CLDirectionArrowWrap": CLDirectionArrowWrap.Register(L); break;
			case "CLEjectorWrap": CLEjectorWrap.Register(L); break;
			case "CLMainWrap": CLMainWrap.Register(L); break;
			case "CLMapTileWrap": CLMapTileWrap.Register(L); break;
			case "CLMaterialCacheWrap": CLMaterialCacheWrap.Register(L); break;
			case "CLModelMgrWrap": CLModelMgrWrap.Register(L); break;
			case "CLModelPoolWrap": CLModelPoolWrap.Register(L); break;
			case "CLMyGridWrap": CLMyGridWrap.Register(L); break;
			case "CLMyTweenRotateWrap": CLMyTweenRotateWrap.Register(L); break;
			...
			case "CLRolePoolWrap": CLRolePoolWrap.Register(L); break;
			case "CLRoleStateWrap": CLRoleStateWrap.Register(L); break;
			case "CLSceneWrap": CLSceneWrap.Register(L); break;
			case "CLSmoothFollowWrap": CLSmoothFollowWrap.Register(L); break;
			case "CLTextureMgrWrap": CLTextureMgrWrap.Register(L); break;
			case "CLThingsPoolWrap": CLThingsPoolWrap.Register(L); break;
			...
			case "CLUnit4LuaWrap": CLUnit4LuaWrap.Register(L); break;
			...
			case "DeviceOrientationWrap": DeviceOrientationWrap.Register(L); break;
			...
			case "SRoleActionWrap": SRoleActionWrap.Register(L); break;
			case "SRoleAvataWrap": SRoleAvataWrap.Register(L); break;
			case "SScreenShakesWrap": SScreenShakesWrap.Register(L); break;
			case "SUnitWrap": SUnitWrap.Register(L); break;
			case "SVersionWrap": SVersionWrap.Register(L); break;
			case "ScreenWrap": ScreenWrap.Register(L); break;
			case "SimpleAI_GridWrap": SimpleAI_GridWrap.Register(L); break;
