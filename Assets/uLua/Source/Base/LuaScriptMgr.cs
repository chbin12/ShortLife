...
//#endif
    ...
    public static object GetNetObject(IntPtr L, int stackPos, Type type)
    {
        ...
        if (obj == null)
        {
//            LuaDLL.luaL_argerror(L, stackPos, string.Format("{0} expected, got nil", type.Name));		// del by chenbin
            return null;
        }
...
//        LuaDLL.luaL_argerror(L, stackPos, string.Format("{0} expected, got {1}", type.Name, objType.Name));		// del by chenbin
        return null;
    }
