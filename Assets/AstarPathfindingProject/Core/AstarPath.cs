...
//#define ASTAR_MORE_PATH_IDS //Increases the number of pathIDs from 2^16 to 2^32. Uses more memory//#define ASTAR_MORE_PATH_IDS //Increases the number of pathIDs from 2^16 to 2^32. Uses more memory//#define ASTAR_MORE_PATH_IDS //Increases the number of pathIDs from 2^16 to 2^32. Uses more memory//#define ASTAR_MORE_PATH_IDS //Increases the number of pathIDs from 2^16 to 2^32. Uses more memory
...
#line default
...
#if ASTARDEBUG
			Debug.Log (debug);		//modify by chenbin
#endif
		}
	}
	 ...
	 */
	//	private void Update () {
	private void FixedUpdate () { // modify by chenbin
