...
public class CLTerrainInfor
{
	...
	{
		ArrayList tmpList = new ArrayList ();
		tmpList.AddRange (tileMaterials);
		string tileMaterialsJson = JSON.JsonEncode (tmpList);
		tmpList.Clear ();
		tmpList.AddRange (ornament4Ground);
		string ornament4GroundJson = JSON.JsonEncode (tmpList);
		tmpList.Clear ();

		for (int i = 0; tileTypes != null && i < tileTypes.Count; i++) {
			tmpList.Add (tileTypes[i].ToString());
		}
		string tileTypesJson = JSON.JsonEncode (tmpList);
		tmpList.Clear ();

		for (int i = 0; ornTypes != null && i < ornTypes.Count; i++) {
			tmpList.Add (ornTypes[i].ToString());
		}
		string ornTypesJson = JSON.JsonEncode (tmpList);
		tmpList.Clear ();
		...
		json = PStr.b ()
			...
			.a ("\"name\":\"").a (name).a ("\",")
			.a ("\"ground\":\"").a (ground).a ("\",")
			.a ("\"groundHigh\":").a (groundHigh).a (",")
			.a ("\"ornament4GroundHigh\":").a (ornament4GroundHigh).a (",")
			.a ("\"skyMaterial\":\"").a (skyMaterial).a ("\",")
			.a ("\"skyOranment\":\"").a (skyOranment).a ("\",")
			.a ("\"lookatAngle\":").a (lookatAngle).a (",")
			.a ("\"effect\":\"").a (effect).a ("\",")
			.a ("\"fog\":").a (fog.ToString().ToLower()).a (",")
			.a ("\"fogDensity\":").a (fogDensity).a (",")
			.a ("\"fogStartDis\":").a (fogStartDis).a (",")
			.a ("\"fogEndDis\":").a (fogEndDis).a (",")
			.a ("\"fogColor\":").a (JSON.JsonEncode (Utl.colorToMap (fogColor))).a (",")
