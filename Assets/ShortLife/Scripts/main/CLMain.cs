...
//	}
	...
	LuaFunction lfOnOrientationChanged = null;
	public override void initGetLuaFunc ()
	{
		base.initGetLuaFunc ();
		lfexitGmaeConfirm = getLuaFunction ("exitGmaeConfirm");
		lfOnOrientationChanged = getLuaFunction ("onOrientationChanged");
	}

	public DeviceOrientation currOrientation = DeviceOrientation.Unknown;
	...
	public override void Update ()
	{
		...
		if(Input.deviceOrientation != currOrientation) {
			currOrientation = Input.deviceOrientation;
			if(lfOnOrientationChanged != null) {
				lfOnOrientationChanged.Call(currOrientation);
			}
		}
	}
