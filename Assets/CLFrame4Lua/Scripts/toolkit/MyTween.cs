...
public class MyTween : MonoBehaviour
{
	...
	public void flyout (Vector3 dirFrom, Vector3 dirTo, float distance, float speed, float hight, 
	...
	public void flyout (Vector3 dir, float distance, float speed, float hight, 
		object onMovingCallback, object finishCallback, bool isWoldPos)
	{
	...
	public  void flyout (Vector3 toPos, float speed, float ihight, 
		object onMovingCallback, object finishCallback, bool isWoldPos)
	{
		flyout (toPos, speed, ihight, onMovingCallback, finishCallback, null, isWoldPos);
	}
