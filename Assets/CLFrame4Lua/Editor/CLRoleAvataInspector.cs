...
#if UNITY_3_5
[CustomEditor(typeof(SRoleAvata))]
#else
[CustomEditor(typeof(SRoleAvata), true)]
#endif
...
//                        newBodyPart.materials.Clear ();
		...
		CLEditorTools.EndContents ();
		testPartName = EditorGUILayout.TextField (testPartName);
		testCellName = EditorGUILayout.TextField (testCellName);
